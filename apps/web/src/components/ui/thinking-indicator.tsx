...
const words = [
  "Juggling Ideas",
  "Teaching Ducks Philosophy",
  "Borrowing Extra Brainpower",
  "Consulting the Void",
  "Translating Chaos",
  "Herding Cats",
  "Whispering to Circuits",
  "Mining for Wisdom",
  "Taming Wild Thoughts",
  "Shaking the Idea Tree",
  "Searching Alternate Timelines",
  "Bribing the Hamsters",
  "Following Suspicious Clues",
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        >
          <span className="col-start-1 row-start-1 invisible text-shimmer" aria-hidden="true">
            {words.reduce((a, b) => (a.length >= b.length ? a : b))}
          </span>
          <AnimatePresence mode="popLayout" initial={false}>
            <motion.span
              key={words[index]}
              className="col-start-1 row-start-1 text-shimmer"
