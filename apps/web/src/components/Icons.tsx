...
export const GitHubIcon: Icon = (props) => (
  <svg data-pipper-id="git-hub-icon" {...props} viewBox="0 0 1024 1024" fill="none">
    <path
      fillRule="evenodd"
      clipRule="evenodd"
...
export const GitIcon: Icon = (props) => (
  <svg data-pipper-id="git-icon" {...props} viewBox="0 0 256 256">
    <path
...
export const JujutsuIcon: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="jujutsu-icon" {...props} viewBox="0 0 1024 1024">
      <defs>
        <g id={groupId}>
          <path
...
export const GitLabIcon: Icon = (props) => (
  <svg data-pipper-id="git-lab-icon" {...props} viewBox="0 0 32 32" fill="none">
    <path
...
export const AzureDevOpsIcon: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="azure-dev-ops-icon" {...props} viewBox="0 0 96 96">
      <defs>
        <linearGradient
          id={gradientA}
          x1="-1032.17"
...
export const BitbucketIcon: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="bitbucket-icon" {...props} viewBox="8.4 14.39 2481.29 2231.21">
...
export const TraeIcon: Icon = (props) => (
  <svg data-pipper-id="trae-icon" {...props} viewBox="0 0 24 24" fill="currentColor">
...
export const KiroIcon: Icon = (props) => (
  <svg data-pipper-id="kiro-icon" {...props} viewBox="0 0 1200 1200" fill="none">
...
export const VisualStudioCode: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="visual-studio-code" {...props} fill="none" viewBox="0 0 100 100">
...
export const VisualStudioCodeInsiders: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="visual-studio-code-insiders" {...props} fill="none" viewBox="0 0 100 100">
      <mask id={maskId} width="100" height="100" x="0" y="0" maskUnits="userSpaceOnUse">
        <path
          fill="#fff"
          fillRule="evenodd"
...
export const VSCodium: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="vs-codium" {...props} viewBox="0 0 100 100">
      <defs>
        <linearGradient
          id={gradientId}
          x1="0"
...
export const Zed: Icon = (props) => {
  ...
  return (
    <svg data-pipper-id="zed" {...props} fill="none" viewBox="0 0 96 96">
...
export const Gemini: Icon = (props) => (
  <svg data-pipper-id="gemini" {...props} viewBox="0 0 296 298" fill="none">
    <mask
      id="gemini__a"
      width="296"
      height="298"
...
export const AntigravityIcon: Icon = (props) => (
  <svg data-pipper-id="antigravity-icon" {...props} viewBox="0 0 128 128" fill="none">
...
export const GithubCopilotIcon: Icon = ({ className, ...props }) => (
  <svg
    data-pipper-id="github-copilot-icon"
    {...props}
    preserveAspectRatio="xMidYMid"
    viewBox="0 0 256 208"
    className={cn("fill-black dark:fill-white", className)}
...
export const ACPRegistryIcon: Icon = ({ className, ...props }) => (
  <svg
    data-pipper-id="acp-registry-icon"
    {...props}
    viewBox="0 0 576 220"
    fill="none"
    className={cn("fill-black dark:fill-white", className)}
