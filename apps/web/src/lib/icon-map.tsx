...
function tabler(
  ...
  return function TablerAdapter({ size, strokeWidth, className }: IconComponentProps) {
    const props: { size?: number; stroke?: number; className?: string } = {};
    if (size !== undefined) props.size = size;
    if (strokeWidth !== undefined) props.stroke = strokeWidth;
...
function phosphor(
  ...
  return function PhosphorAdapter({ size, strokeWidth, className }: IconComponentProps) {
    ...
    const props: { size?: number; weight?: PhosphorWeight; className?: string } = { weight };
    if (size !== undefined) props.size = size;
    if (className !== undefined) props.className = className;
    return <Icon {...props} />;
  };
...
function hugeicons(iconDef: unknown): IconComponent {
  return function HugeIconsAdapter({ size, strokeWidth, className }: IconComponentProps) {
    const props: { size?: string | number; strokeWidth?: number; className?: string } = {};
    if (size !== undefined) props.size = size;
